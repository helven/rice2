    ...
    <table class="order_detail" border="0" cellspacing="0" cellpadding="0">
        <thead>
            <tr>
                ...
                <th colspan="3" style="width:370px;"><span style="font-weight:300;">{{ $order->address?->name }}. {{ $order->address->mall?->name ?: $order->address->area?->name.', '.$order->address->area?->postal }}</span></th>
