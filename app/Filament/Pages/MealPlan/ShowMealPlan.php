...
class ShowMealPlan extends Page
{
    protected static ?string $navigationGroup = 'Orders';
    protected static ?string $title = 'View Meal Plan';
    protected static ?string $slug = 'meal-plans/{id}';
    protected static bool $shouldRegisterNavigation = false;

    protected static string $view = 'filament.pages.meal-plan.show-meal-plan';
    ...
    public function getDeliveriesData(): array
    {
        ...
        return $this->order->deliveries
            ...
            ->map(function ($delivery) use ($today) {
                return [
